...
Процедура ЗаполнитьТЧ()
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ГДЕ
	               |	ЗаказНаСборку.Статус В (ЗНАЧЕНИЕ(Перечисление.СтатусыВнутреннихЗаказов.КВыполнению))
	               |	И ЗаказНаСборку.ПометкаУдаления = &ПометкаУдаления
	               |
	               |ОБЪЕДИНИТЬ
	               |
	               |ВЫБРАТЬ
	               ...
	               |	ЗаказНаВнутреннееПотребление.Номер
	               |ИЗ
	               |	Документ.ЗаказНаВнутреннееПотребление КАК ЗаказНаВнутреннееПотребление
	               |ГДЕ
	               |	(ЗаказНаВнутреннееПотребление.Статус В (ЗНАЧЕНИЕ(Перечисление.СтатусыВнутреннихЗаказов.КВыполнению)) И ЗаказНаВнутреннееПотребление.СтатусСборки В (ЗНАЧЕНИЕ(Перечисление.СК_СтатусСборкиРеализации.НеСобран)))
	               |	И ЗаказНаВнутреннееПотребление.ПометкаУдаления = &ПометкаУдаления";
